...
/// <summary>
/// class used to manage the logic of creating a single block
/// </summary>
public class Block
{
	...
	Vector3 position;
	/// <summary>
	/// used to determine the texture needed to be applied on the face
	/// </summary>
	Vector2[,] blockUVs = { 
	...
	/// <summary>
	/// constructor of the class used to determine the type
	/// </summary>
	/// <param name="b"></param>
	...
	/// <summary>
	/// function used to determine if the face has a solid neighbour
	/// </summary>
	/// <param name="x"></param>
	/// <param name="y"></param>
	/// <param name="z"></param>
	...
	/// <summary>
	/// used to draw the quad in the right position if needed
	/// </summary>
	public void Draw()
	{
